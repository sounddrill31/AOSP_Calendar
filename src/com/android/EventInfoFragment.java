...
public class EventInfoFragment extends DialogFragment implements OnCheckedChangeListener,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
	    ...
	    /*
            fix bug:
	    1.To launch Calendar and create a reminder,save it;
	    2.To check the aganda which has a default value of reminder time,eg.10min. Then reset it to 15min through clicking the dropdonw list;
	    3.click the edit item on the right-top corner,it still displays 10min in the column reminder. 
	    */
	    saveResponse();
	    saveReminders();

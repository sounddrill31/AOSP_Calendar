...
import android.provider.CalendarContract.ExtendedProperties;// iCal feature
...
public class EventInfoFragment extends DialogFragment implements OnCheckedChangeListener,
    ...
    private static final int TOKEN_QUERY_EXTENDED_PROPERTIES = 1 << 7;// iCal feature
    ...
    private static final int TOKEN_QUERY_ALL = TOKEN_QUERY_DUPLICATE_CALENDARS
            ...
            | TOKEN_QUERY_EXTENDED_PROPERTIES;// iCal feature
    ...
    private static final String[] EVENT_PROJECTION = new String[] {
        ...
        // Begin iCal feature
        Events.AVAILABILITY,         // 23
        // End iCal feature
    };
    private static final int EVENT_INDEX_ID = 0;
    public static final int EVENT_INDEX_TITLE = 1;// iCal feature, change to public
    public static final int EVENT_INDEX_RRULE = 2;// iCal feature, change to public
    public static final int EVENT_INDEX_ALL_DAY = 3;// iCal feature, change to public
    public static final int EVENT_INDEX_CALENDAR_ID = 4;// iCal feature, change to public
    private static final int EVENT_INDEX_DTSTART = 5;
    private static final int EVENT_INDEX_SYNC_ID = 6;
    public static final int EVENT_INDEX_EVENT_TIMEZONE = 7;// iCal feature, change to public
    public static final int EVENT_INDEX_DESCRIPTION = 8;// iCal feature, change to public
    public static final int EVENT_INDEX_EVENT_LOCATION = 9;// iCal feature, change to public
    public static final int EVENT_INDEX_ACCESS_LEVEL = 10;// iCal feature, change to public
    private static final int EVENT_INDEX_CALENDAR_COLOR = 11;
    private static final int EVENT_INDEX_EVENT_COLOR = 12;
    public static final int EVENT_INDEX_HAS_ATTENDEE_DATA = 13;// iCal feature, change to public
    ...
    public static final int EVENT_INDEX_DURATION = 21;// iCal feature, change to public
    ...
    public class QueryHandler extends AsyncQueryService {// iCal feature
    ...
    public void onStop() {
        ...
        if (!mEventDeletionStarted && act != null && !act.isChangingConfigurations() && !mIsIcsImport) {// iCal feature, add !mIsIcsImport

...
(context: Context) : SimpleWeekView(context) {
    ...
    protected override fun initView() {
        ...
        if (!mInitialized) {
            ...
            if (mScale != 1f) {
                ...
                DAY_SEPARATOR_VERTICAL_LENGHT_PORTRAIT *= mScale.toInt()
    ...
    fun updateToday(tz: String): Boolean {
        ...
        val julianToday: Int = Time.getJulianDay(today.toMillis(false), today.gmtoff)

...
public class VCalComposer_V1 implements VCalComposer {
    ...
    */
     ...
     * @return iCal stream with utf-8 format
     */
    ...
    private void appendAttendees() {
        ...
        while(it.hasNext()) {
            ...
            if(!TextUtils.isEmpty(att.email)) {
                ...
                params.add("PARTSTAT");
                String statusvalue = ICalNames.STATUS_NEEDS_ACTION;
                switch(att.status) {
    ...
    */
    ...
    private void appendEventBody() {
        ...
        if (!TextUtils.isEmpty(mCe.rrule)) {
            ...
            if (mCe.dtEnd == CalendarEvent.INVALID_MIILISEC) {
    ...
    private void appendRrule(String rrule) {
        ...
        try {
                ...
                case EventRecurrence.MONTHLY:
                    ...
                    if (recurrence.bydayCount > 0) {
                        ...
                        if (recurrence.bysetposCount > 0) {
                            ...
                            for (int i = 0; i < recurrence.bydayCount; ++i) {
                                strBuilder.append(' ');
                                if (recurrence.bydayNum[i] < 0) {
                                    strBuilder.append((-1)*(recurrence.bydayNum[i])).append('-');
                                } else {
                                    strBuilder.append(recurrence.bydayNum[i]).append('+');
                                }
                                strBuilder.append(' ').append(day2String(recurrence.byday[i]));
                            }
                        }
            ...
            if (strBuilder.length() > 0) {
                ...
                if (DEVELOPMENT) {
                    Log.v(TAG, "Rrule is: " + strBuilder.toString());
                }
    ...
    private void appendDateTime(String propName, long dtTime) {
        ...
        if (dtTime != -1L) {
            ...
            t.set(dtTime);
            mBuilder.appendDateTime(propName, null, t.format2445());
        }
    }
    ...
    */
    private void appendHeader() {
        ...
        // Always use UTC time
        mBuilder.appendProperty("TZ", "+00:00");
        mBuilder.appendProperty("DAYLIGHT", "FALSE");
    }
        ...
        while (it.hasNext()) {
            ...
            if (alm.method == Reminders.METHOD_ALERT) {
                ...
                mBuilder.appendProperty("DALARM",
                        new StringBuilder(t.format2445()).append(";PT5M").append(";1")
                        .append("").toString());
            }
        }
    }
